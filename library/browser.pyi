...
# external
from typing import Any, Callable, List, NoReturn, Union as U
...
class Browser:
	...
	""" from frames.py """
	def send_method_to_element_in_frame(self, frame_locator: U[WebElement, str],
	        element_locator: U[WebElement, str], method: Callable) -> Any: ...
	def select_frame(self, locator: U[WebElement, str]) -> NoReturn: ...
